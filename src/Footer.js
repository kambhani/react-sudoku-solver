  ...
  return (
    <footer className="w-full text-gray-200 bg-gray-800 text-justify mt-6 flex justify-center items-center py-4 px-8">
      <div className="w-full grid grid-cols-12 flex sm:block items-center">
        ...
        <p className="col-span-7 italic text-sm font-semibold text-justify md:text-center">A 100% open source project developed by Anish Kambhampati, dedicated to all those who love the art of sudoku.</p>
      </div>
    </footer>
  )
}
