...
const About = ({view}) => {
  return (
    <div className={(view === 'about') ? "grid grid-cols-12" : "hidden"}>
      <div className="mt-3 px-3 col-span-12 lg:col-span-10 lg:px-6 dark:text-gray-200">
        <div className="px-2 sm:px-5 md:px-12">   
          ...
          <p className="text-justify text-lg font-light">Sudoku has been around for a while with early versions from Euler dating back to the late 18<sup>th</sup> century. The sudoku as we know it today, however, debuted around 40 years ago in a Manhatten based puzzle magazine<sup><a href="https://www.theguardian.com/media/2005/may/15/pressandpublishing.usnews">^</a></sup>. (I, too, was shocked to learn that the "sudoku" did not, in fact, come from Japan.) Since then, it has become an international phenonmenon. People from all walks of life joined in to try their luck at the number puzzle. This includes me — I fondly remember solving these puzzles with my grandmother.</p>
          <h2 className="text-2xl my-1">This Project</h2>
          <p className="text-justify text-lg font-light">Maybe you're stuck on a sudoku and need some help. Or maybe you need to flex your sudoku solving skills to your friends. Regardless of your reason, I feel that the sudoku solver can help. It is designed to be an intuitive way to solve your sudokus. This application builds upon an earlier, command-line only version which can be found <a className="text-blue-700" href="https://github.com/kambhani/sudoku-solver">here</a>.</p>
